...
pub fn _mouse_moved_callback(window: &Rc<wgpu::web_sys::Window>, state: Rc<RefCell<State>>) {
    let mouse_moved_closure: Closure<dyn FnMut(leptos::web_sys::MouseEvent)> = Closure::wrap(Box::new({
...
pub fn resize_callback(window: &Rc<wgpu::web_sys::Window>, state: Rc<RefCell<State>>, canvas: Arc<wgpu::web_sys::HtmlCanvasElement>) {
